...
import calculateLevelFrag from './calculate-level.frag'
import calculateLevelVert from './calculate-level.vert'
import forceFrag from './force-level.frag'
import forceCenterFrag from './force-centermass.frag'
...
export class ForceManyBody<N extends CosmosInputNode, L extends CosmosInputLink> extends CoreModule<N, L> {
    ...
    public initPrograms(): void {
        ...
        this.calculateLevelsCommand = reglInstance({
            ...
            framebuffer: (_: regl.DefaultContext, props: {
                levelFbo: regl.Framebuffer2D;
            ...
            uniforms: {
                ...
                levelTextureSize: (_: regl.DefaultContext, props: {
                    levelTextureSize: number
                }) => props.levelTextureSize,
