...
const methodDescriptions = {
    ...
    "This algorithm constructs a rooted tree (rectangular) that reflects the structure present in a pairwise dissimilarity matrix. At each step, the nearest two clusters are combined into a higher-level cluster. The distance between any two clusters A and B is the mean distance between elements of each cluster.\n" +
