...
/**
 * Implementation of the {@link ObjectStorageRepository} interface for the Cloud environment.
 */
@Repository
@Primary
public class ObjectStorageRepositoryCloud implements ObjectStorageRepository {
    ...
    public ObjectStorageRepositoryCloud(
    ...
    public boolean delete(String url) {
        ...
        os.objectStorage().objects().delete(containerName, url.substring(getLocation().length()));
