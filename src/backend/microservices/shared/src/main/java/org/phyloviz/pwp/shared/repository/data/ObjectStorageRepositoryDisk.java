...
/**
 * Implementation of the {@link ObjectStorageRepository} interface that stores the uploaded files in the disk.
 */
@Repository
public class ObjectStorageRepositoryDisk implements ObjectStorageRepository {
