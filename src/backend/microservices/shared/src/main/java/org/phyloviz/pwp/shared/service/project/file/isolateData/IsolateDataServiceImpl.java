...
import org.phyloviz.pwp.shared.adapters.isolateData.IsolateDataAdapterFactory;
...
public class IsolateDataServiceImpl implements IsolateDataService {
    ...
    public UploadIsolateDataOutput uploadIsolateData(String projectId, MultipartFile multipartFile, String userId) {
        ...
        String url = isolateDataAdapterFactory.getIsolateDataAdapter("s3")
        ...
        final IsolateDataMetadata isolateDataMetadata = new IsolateDataMetadata(
                ...
                "s3",
                new IsolateDataS3AdapterSpecificData(url, multipartFile.getOriginalFilename())
        );
