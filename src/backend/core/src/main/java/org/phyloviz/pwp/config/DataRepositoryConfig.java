...
import org.phyloviz.pwp.repository.data.distance_matrix.repository.DistanceMatrixS3DataRepository;
...
import org.phyloviz.pwp.repository.data.isolate_data.repository.IsolateDataS3DataRepository;
...
import org.phyloviz.pwp.repository.data.registry.distance_matrix.DistanceMatrixDataRepositoryRegistryImpl;
import org.phyloviz.pwp.repository.data.registry.isolate_data.IsolateDataDataRepositoryRegistry;
import org.phyloviz.pwp.repository.data.registry.isolate_data.IsolateDataDataRepositoryRegistryImpl;
import org.phyloviz.pwp.repository.data.registry.tree.TreeDataRepositoryRegistry;
import org.phyloviz.pwp.repository.data.registry.tree.TreeDataRepositoryRegistryImpl;
import org.phyloviz.pwp.repository.data.registry.tree_view.TreeViewDataRepositoryRegistry;
import org.phyloviz.pwp.repository.data.registry.tree_view.TreeViewDataRepositoryRegistryImpl;
import org.phyloviz.pwp.repository.data.registry.typing_data.TypingDataDataRepositoryRegistry;
import org.phyloviz.pwp.repository.data.registry.typing_data.TypingDataDataRepositoryRegistryImpl;
import org.phyloviz.pwp.repository.data.tree.TreeDataRepositoryId;
import org.phyloviz.pwp.repository.data.tree.repository.TreeS3DataRepository;
import org.phyloviz.pwp.repository.data.tree.repository.specific_data.TreeS3DataRepositorySpecificData;
import org.phyloviz.pwp.repository.data.tree_view.TreeViewDataRepositoryId;
import org.phyloviz.pwp.repository.data.tree_view.repository.TreeViewS3DataRepository;
import org.phyloviz.pwp.repository.data.tree_view.repository.specific_data.TreeViewS3DataRepositorySpecificData;
import org.phyloviz.pwp.repository.data.typing_data.TypingDataDataRepositoryId;
import org.phyloviz.pwp.repository.data.typing_data.repository.TypingDataS3DataRepository;
import org.phyloviz.pwp.repository.data.typing_data.repository.specific_data.TypingDataS3DataRepositorySpecificData;
