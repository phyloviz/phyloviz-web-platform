...
import org.phyloviz.pwp.shared_phylodb.repository.data.phylodb.tree_view.TreeViewPhyloDBDataRepositorySpecificData;
import org.phyloviz.pwp.shared_phylodb.repository.data.phylodb.typing_data.TypingDataPhyloDBDataRepository;
import org.phyloviz.pwp.shared_phylodb.repository.data.phylodb.typing_data.TypingDataPhyloDBDataRepositorySpecificData;
...
public class DataRepositoryConfig {
    ...
    public TreeDataRepositoryRegistry treeDataRepositoryRegistry(ApplicationContext context) {
        return new TreeDataRepositoryRegistryImpl(context, Map.of(
                ...
                TreeDataRepositoryId.PHYLODB, TreePhyloDBDataRepository.class
        ), Map.of(
    ...
    public TreeViewDataRepositoryRegistry treeViewDataRepositoryRegistry(ApplicationContext context) {
        return new TreeViewDataRepositoryRegistryImpl(context, Map.of(
                ...
                TreeViewDataRepositoryId.PHYLODB, TreeViewPhyloDBDataRepository.class
        ), Map.of(
    ...
    public TypingDataDataRepositoryRegistry typingDataDataRepositoryRegistry(ApplicationContext context) {
        return new TypingDataDataRepositoryRegistryImpl(context, Map.of(
                ...
                TypingDataDataRepositoryId.PHYLODB, TypingDataPhyloDBDataRepository.class
        ), Map.of(
